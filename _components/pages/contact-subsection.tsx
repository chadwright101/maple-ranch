        ...
        {showEmail === "Show email address" ? (
          <button
            ...
            className={classNames(
              "text-paragraph py-3 px-2 -my-3 -mx-2 place-self-start text-link-blue hover:cursor-pointer text-left tablet:p-0 tablet:m-0 italic desktop:hover:text-black ease-in-out duration-300",
              {
                "text-white": whiteText,
              }
            )}
