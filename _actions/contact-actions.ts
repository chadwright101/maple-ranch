...
const adventuresEmail = process.env.CONTACT_ADVENTURES_EMAIL;
const adventuresPhone = process.env.CONTACT_ADVENTURES_PHONE;
const restaurantEmail = process.env.CONTACT_RESTAURANT_EMAIL;
const restaurantPhone = process.env.CONTACT_RESTAURANT_PHONE;
const generalEmail = process.env.CONTACT_GENERAL_EMAIL;
